...
export default class planejamento extends Component {
    ...
    selecionaGrafico = param => {
        const { opt, dados } = param;

        this.state.graficoSelecionado = opt;

        this.processaDadosGrafico(dados);
    };
            ...
            dataPoints = [
                {
                    ...
                    value: parseFloat(
                        (
                            (dados.previsto.qtdSol.qtdTotal * 100) /
                            total
                        ).toFixed(2)
                    ),
                },
                {
                    title: 'Atenção',
                    value: parseFloat(
                        ((dados.atencao.qtdSol.qtdTotal * 100) / total).toFixed(
                            2
                        )
                    ),
                },
                {
                    ...
                    value: parseFloat(
                        (
                            (dados.atrasado.qtdSol.qtdTotal * 100) /
                            total
                        ).toFixed(2)
                    ),
                },
                {
                    ...
                    value: parseFloat(
                        (
                            (dados.concluido.qtdSol.qtdTotal * 100) /
                            total
                        ).toFixed(2)
                    ),
                },
            ...
            dataPoints = [
                {
                    ...
                    value: parseFloat(
                        (
                            (dados.previsto.qtdFix.qtdTotal * 100) /
                            total
                        ).toFixed(2)
                    ),
                },
                {
                    title: 'Atenção',
                    value: parseFloat(
                        ((dados.atencao.qtdFix.qtdTotal * 100) / total).toFixed(
                            2
                        )
                    ),
                },
                {
                    ...
                    value: parseFloat(
                        (
                            (dados.atrasado.qtdFix.qtdTotal * 100) /
                            total
                        ).toFixed(2)
                    ),
                },
                {
                    ...
                    value: parseFloat(
                        (
                            (dados.concluido.qtdFix.qtdTotal * 100) /
                            total
                        ).toFixed(2)
                    ),
                },
    ...
    render() {
        ...
        return (
            <Html
                ...
                seriesGrafico={seriesGrafico}
                total={total}
                totalHorasConcluido={totalHorasConcluido}
                totalHoras={totalHoras}
                selecionaGrafico={this.selecionaGrafico}
                graficoSelecionado={graficoSelecionado}
                processaDadosGrafico={this.processaDadosGrafico}
            />
        );
    }
}
